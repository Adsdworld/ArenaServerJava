...
public class EntityPositions {
    ...
    public static final Map<String, Position> BLUE_TOWERS = Map.ofEntries(
            Map.entry("T4_TOP_BLUE", new Position(312.82f, 9.37f, 357.67f, 180f)),
            Map.entry("T3_TOP_BLUE", new Position(294.68f, 9.37f, 423.74f, 135f)),
            ...
            Map.entry("T4_BOT_BLUE", new Position(327.72f, 9.37f, 342.34f, 180f)),
            Map.entry("T3_MID_BLUE", new Position(375.67f, 9.37f, 403.40f, 180f)),
            ...
            Map.entry("T3_BOT_BLUE", new Position(396.33f, 9.37f, 324.44f, 225f)),
    ...
    public static final Map<String, Position> RED_TOWERS = Map.ofEntries(
            Map.entry("T4_TOP_RED", new Position(665.27f, 9.37f, 709.47f, 0f)),
            Map.entry("T3_TOP_RED", new Position(597.55f, 9.37f, 726.01f, 45f)),
            Map.entry("T2_TOP_RED", new Position(512.38f, 8.07f, 718.81f, 45f)),
            Map.entry("T1_TOP_RED", new Position(396.16f, 8.07f, 733.47f, 45f)),
            Map.entry("T4_BOT_RED", new Position(679.5f, 9.37f, 694.41f, 0f)),
            Map.entry("T3_MID_RED", new Position(617.9f, 9.37f, 646.95f, 0f)),
            Map.entry("T2_MID_RED", new Position(572.77f, 8.07f, 610.8f, 0f)),
            Map.entry("T1_MID_RED", new Position(546.98f, 8.07f, 559.76f, 0f)),
            Map.entry("T3_BOT_RED", new Position(698.42f, 9.37f, 628.12f, 315f)),
    ...
    public static final Map<String, Position> BLUE_NEXUS = Map.of(
            "NEXUS_BLUE", new Position(307.62f, -13.5f, 337.96f, 0f)
    );

    public static final Map<String, Position> RED_NEXUS = Map.of(
            "NEXUS_RED", new Position(685.20f, -13.5f, 713.00f, 0f)
    );
}
